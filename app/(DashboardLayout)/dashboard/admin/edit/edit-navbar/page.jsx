...
import navbar from "@/assets/image/dashboardImages/navbar.png";
...
const Page = () => {
  ...
  return (
    <>
      ...
      />
      <div className="descriptionArea lg:flex m-5">
        <div className="imgArea relative lg:w-1/2">
          <Image
            src={navbar}
            width={""}
            height={""}
        ...
        <div className="informations lg:w-1/2 flex flex-col items-start justify-center bg-gray-100 p-1 lg:p-5 rounded-xl my-5 lg:my-0 mx-0 lg:mx-5">

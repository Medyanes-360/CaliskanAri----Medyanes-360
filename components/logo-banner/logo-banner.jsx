...
export const LogoBanner = () => {
  return (
    ...
    <div className="mx-auto container px-6">
      ...
      <p className="text-center text-cst_grey text-base pt-4">Uzman kadromuz ve profesyonel çalışma ortaklarımız ile sizlere en iyi hizmeti vermekten mutluluk duyuyoruz.</p>

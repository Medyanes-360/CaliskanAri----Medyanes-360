...
export const BlogSectionSlider = () => {
  ...
  useEffect(() => {
    ...
    if (blogcardinLocalStorage) {
      setBlogcard(blogcardinLocalStorage);
    }
  }, []);
            ...
            <div className="flex flex-col items-center gap-3 bg-white border border-border rounded-lg pb-10">
              <figure className="overflow-hidden">
                <img
                  src={item.image}
                  alt=""
                  className="rounded-t-lg hover:transform hover:scale-105 transition-transform duration-300 ease-in-out"
                />
              </figure>
              <div className="flex flex-col items-start ps-8 gap-2">
                <p className="text-base rounded-md bg-plant text-buttonColor px-3">
                  {item.role}
                </p>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex gap-1 justify-between text-tabs ">
                    <span className="text-tabs text-base flex items-center gap-2">
                      <span className="text-md text-buttonColor">
                        {' '}
                        <SlCalender />
                      </span>
                    ...
                    <span className="font-medium text-cst_purple test-base">
                      {item.by}
                    </span>
                  </div>
                </div>
